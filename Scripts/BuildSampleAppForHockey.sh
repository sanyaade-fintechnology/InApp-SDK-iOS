...
xcodebuild -workspace PaylevenInAppSDK.xcworkspace -scheme PaylevenInAppSDKExample -configuration Release -sdk iphoneos -destination 'generic/platform=iOS' archive -archivePath $BUILD_ROOT/$PRODUCT_NAME
