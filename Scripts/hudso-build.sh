...
xcodebuild VALID_ARCHS="armv7 armv7s arm64" ARCHS="armv7 arm64" ONLY_ACTIVE_ARCH=NO -workspace "PaylevenInAppSDK.xcworkspace" -scheme "${XCODE_SCHEME}" -sdk "iphoneos8.1" -configuration Debug clean build || exit 1 ;
